        ...
        <?php if (have_posts()) : ?>
            ...
            <?php while (have_posts()) : the_post(); ?>
                ...
                <?php endif; ?>
                    ...
                    /*wp_link_pages(array('before' => '<div class="pagination">' . __('Pages:', 'gconverter'), 'after' => '</div>'));
                    
                    $response = wp_remote_get( "http://ws-old.parlament.ch/affairs/20163576?format=json" );
					$data = json_decode( $response );
					echo 'The movie ' . esc_html( $data['id'] ) . ' was released in ' . absint( $data['name'] ) . '.';*/
